...
options=(
    "1 Crear usuarios" "Permite crear un o varios usuarios"
    "2 Modificar usuarios" "Permite modificar los valores de un usuario, como el directorio home, nombre, contraseña..."
    "3 Listar usuarios" "Simplemente muestra un listado de los usuarios"
    "4 Borrar usuarios" "Borra los usuarios que se marquen"
)
